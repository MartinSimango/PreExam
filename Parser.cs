...
public class Parser {
	...
	public const int string_Sym = 20;
	...
	public const int else_Sym = 26;
	public const int while_Sym = 27;
	public const int do_Sym = 28;
	public const int halt_Sym = 29;
	public const int return_Sym = 30;
	public const int read_Sym = 31;
	public const int readLine_Sym = 32;
	public const int write_Sym = 33;
	public const int writeLine_Sym = 34;
	public const int barbar_Sym = 35;
	public const int andand_Sym = 36;
	public const int plus_Sym = 37;
	public const int minus_Sym = 38;
	public const int bang_Sym = 39;
	public const int upper_Sym = 40;
	public const int new_Sym = 41;
	public const int star_Sym = 42;
	public const int slash_Sym = 43;
	...
	public const int equal_Sym = 51;
	public const int NOT_SYM = 52;
	// pragmas
	public const int CodeOn_Sym = 53;
	public const int CodeOff_Sym = 54;
	public const int DebugOn_Sym = 55;
	public const int DebugOff_Sym = 56;
	public const int StackDump_Sym = 57;
	public const int HeapDump_Sym = 58;
	public const int TableDump_Sym = 59;

	public const int maxT = 52;
	public const int _CodeOn = 53;
	public const int _CodeOff = 54;
	public const int _DebugOn = 55;
	public const int _DebugOff = 56;
	public const int _StackDump = 57;
	public const int _HeapDump = 58;
	public const int _TableDump = 59;
...
/* -------------------------------------------------------- */
	...
	static void Statement(StackFrame frame) {
		...
		case int_Sym: case bool_Sym: case char_Sym: case string_Sym: {
		...
		case plusplus_Sym: case minusminus_Sym: {
			IncDecStatement();
			break;
		}
		case if_Sym: {
	...
	static void Constant(out ConstRec con) {
		...
		case stringLit_Sym: {
			StringConst(out stringValue);
			con.type = Types.stringType;
	...
	static void WriteElement() {
		...
		if (la.kind == stringLit_Sym) {
			...
			Expression(out expType);
			if (!(IsArith(expType) || expType == Types.boolType || expType== Types.stringType))
	...
	static bool[,] set = {
		{T,T,x,x, x,x,x,x, x,T,x,T, T,x,x,x, x,T,T,T, T,T,T,x, x,T,x,T, T,T,T,T, T,T,T,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x},
		{x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,T,T,T, T,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x},
		{x,x,x,x, x,x,x,T, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x},
		{x,T,x,x, x,x,x,x, x,T,x,T, T,x,x,x, x,T,T,T, T,T,T,x, x,T,x,T, T,T,T,T, T,T,T,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x},
		{T,T,x,x, x,T,x,x, x,T,x,T, T,x,x,x, x,T,T,T, T,T,T,x, x,T,x,T, T,T,T,T, T,T,T,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x},
		{T,T,x,x, x,x,x,x, x,T,x,T, T,x,x,x, x,T,T,T, T,T,T,x, x,T,x,T, T,T,T,T, T,T,T,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x},
		{T,T,x,x, x,x,x,x, x,T,T,T, T,x,x,x, x,T,T,T, T,T,T,x, x,T,T,T, T,T,T,T, T,T,T,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x},
		{x,T,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x},
		{x,x,x,x, x,x,x,x, x,x,x,T, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x},
		{x,T,x,x, x,x,x,x, x,T,T,T, T,x,x,x, x,T,T,T, T,T,T,x, x,T,T,T, T,T,T,T, T,T,T,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x},
		{T,T,x,x, x,x,T,x, x,T,x,T, T,x,x,x, x,T,T,T, T,T,T,x, x,T,x,T, T,T,T,T, T,T,T,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x},
		{x,T,T,T, T,x,T,x, x,x,x,x, x,T,T,T, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,T,T,T, T,T,x,x, x,x,x,x, x,x,x,x, x,x},
		...
		{x,T,T,T, T,x,T,x, x,x,x,x, x,T,T,T, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, T,T,x,x, x,x,x,x, x,x,x,x, x,x},
		{x,x,T,T, T,x,x,x, x,x,x,x, x,T,T,T, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x}
...
public class Errors {
	...
	public static void SynErr (int line, int col, int n) {
		...
		switch (n) {
			...
			case 29: s = "\"halt\" expected"; break;
			case 30: s = "\"return\" expected"; break;
			case 31: s = "\"read\" expected"; break;
			case 32: s = "\"readLine\" expected"; break;
			case 33: s = "\"write\" expected"; break;
			case 34: s = "\"writeLine\" expected"; break;
			case 35: s = "\"||\" expected"; break;
			case 36: s = "\"&&\" expected"; break;
			case 37: s = "\"+\" expected"; break;
			case 38: s = "\"-\" expected"; break;
			case 39: s = "\"!\" expected"; break;
			case 40: s = "\"upper\" expected"; break;
			...
			case 55: s = "invalid AssignmentOrCall"; break;
			case 56: s = "invalid AssignmentOrCall"; break;
			case 57: s = "invalid IncDecStatement"; break;
			case 58: s = "invalid IfStatement"; break;
			case 59: s = "invalid ReadStatement"; break;
			case 60: s = "invalid WriteStatement"; break;
			case 61: s = "invalid Constant"; break;
			case 62: s = "invalid BasicType"; break;
			case 63: s = "invalid ReadElement"; break;
			case 64: s = "invalid WriteElement"; break;
			case 65: s = "invalid EqualOp"; break;
			case 66: s = "invalid RelOp"; break;
			case 67: s = "invalid AddOp"; break;
			case 68: s = "invalid Factor"; break;
			case 69: s = "invalid MulOp"; break;
